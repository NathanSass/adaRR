	...
	var Router = React.createClass({
		...
		componentDidMount: function () {
			...
			page('/chooseToiletLocation', function (ctx) {
				...
				if ( self.getData().length === 0) {
					roomsData = [{"id":"canvas1","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":90,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":305,"y":45.72}},"note":"firstVert, 1st","canvasSize":426.92},{"id":"canvas2","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":90,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":305,"y":198.28}},"note":"firstVert, 2nd","canvasSize":426.92},{"id":"canvas3","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":180,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":259.28,"y":244}},"note":"secondHorz, 1st","canvasSize":426.92},{"id":"canvas4","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":180,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":45.72,"y":244}},"note":"secondHorz, 2nd","canvasSize":426.92},{"id":"canvas5","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":270,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":0,"y":198.28}},"note":"secondVert, 1st","canvasSize":426.92}];
			...
			page('/addValidFixtures', function (ctx) {
				...
				if (self.getData().length === 0) {
					roomData = JSON.parse('{"data": {"id":"canvas1","maxX":305,"maxY":244,"canvasOffset":60.96,"door":{"pos1":{"x":163.46,"y":60.96},"pos2":{"x":233.46,"y":60.96}},"rotation":90,"toilet":{"depth":71.12,"width":58.42,"bound":{"h":121.92,"w":182.88},"loc":{"distFromWall":45.72,"x":305,"y":45.72}},"note":"firstVert, 1st","canvasSize":426.92}}' );
